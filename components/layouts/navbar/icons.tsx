...
export const Shoppingbag = () => {
    ...
    return ( <><button className="flex flex-col items-center gap-1" onClick={() => setOpenBag(!openBag)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-7 h-7">
